...
<!-- Header -->
<header class="masthead" style="padding-bottom: 50px">
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Sistema de Informacion Botanico del CATIE</div>
            <hr class="my-4">
    ...
    <div class="container" >
        ...
        <div class="container" style="display: table; vertical-align: middle;">
            <div class="centrar">
                ...
                <div class="col-sm-6" style="text-align: center; padding-left: 20px;" >
                    <img src="img/jardin-botanico.jpg">
                </div>
            </div>
        </div>
        <div class="col-md-12" style="text-align: center; padding-top: 20px" >
            <br><button class="btn btn-default btn-lg sombra">Seguir leyendo</button>
        </div>
    </div>
</section>
...
<footer class="container-fluid text-center">
    <a href="#page-top" title="To Top">
        <span class="glyphicon glyphicon-chevron-up">x</span>
    </a>
